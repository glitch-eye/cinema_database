...
('00007011020','plebeian','TP.HCM','2004-02-29','0986987684','0'),
('00025041999','dogdays','TP.HCM','1990-10-21','0482765458','1'),
('00022110000','twewy','TP.HCM','1997-11-14','0486586521','1'),
('00009122012','dancehall','TP.HCM','1987-05-09','0987321546','1'),
('00095829467','superlongusernamethatI''mwritingjustforthesakeofit','TP.HCM','1995-10-31','0865986652','0'),
('00011111919','Demian','TP.HCM','2004-05-28','0987515684','0'),
('0000001895','Hastur','TP.HCM','2000-01-01','0985525228','1'),
('00016011605','Rocinante','TP.HCM','2002-06-23','0321153452','0'),
('00029131915','Kafka','TP.HCM','1998-07-19','0865895274','0'),
('00002291828','Mephisto','TP.HCM','1999-09-20','0931521623','0'),
('00001011936','flymywings','TP.HCM','2007-11-30','0387555648','0'),
('00009121866','ordinary','TP.HCM','1997-03-11','0845586217','0'),
('00004041918','hell','TP.HCM','2008-04-08','0151243516','0'),
('00019051942','stranger','TP.HCM','2007-04-13','0456284531','0'),
('00013131230','Odyssey','TP.HCM','1975-01-23','0795135735','0'),
('00014111851','mobydick','TP.HCM','1994-03-12','0775132548','0'),
('00024111847','wurthering','TP.HCM','2001-11-06','0254687513','0'),
('00006061791','redchamber','TP.HCM','1990-02-14','0587625421','0'),
...
('TM000000002', 'Tom Hardy', '1977-09-15', 0, 30, 0, 1),
('KR000000003', 'Keanu Reeves', '1964-09-02', 0, 40, 0, 1),
('HF000000004', 'Harrison Ford', '1942-07-13', 0, 60, 0, 1),
('LD000000005', 'Leonardo DiCaprio', '1974-11-11', 0, 35, 0, 1),
('CH000000006', 'Charlize Theron', '1975-08-07', 0, 45, 0, 1),
('EG000000007', 'Emma Stone', '1988-11-06', 0, 25, 0, 1),
('RG000000008', 'Ryan Gosling', '1980-11-12', 0, 30, 0, 1),
('AD000000009', 'Amy Adams', '1974-08-20', 0, 30, 0, 1),
('RS000000010', 'Ridley Scott', '1937-11-30', 25, 0, 1, 0),
('SP000000011', 'Steven Spielberg', '1946-12-18', 33, 5, 1, 1),
('CH000000012', 'Chad Stahelski', '1968-09-20', 4, 5, 1, 1),
('AW000000013', 'Alfonso Cuarón', '1961-11-28', 10, 0, 1, 0),
('DF000000014', 'David Fincher', '1962-08-28', 12, 0, 1, 0),
('WB000000015', 'Wes Anderson', '1969-05-01', 11, 2, 1, 1),
('DP000000016', 'Denis Villeneuve', '1967-10-03', 10, 0, 1, 0),
('PC000000017', 'Park Chan-wook', '1963-08-23', 15, 0, 1, 0),
('JK000000018', 'Jack Nicholson', '1937-04-22', 0, 50, 0, 1),
('RD000000019', 'Ralph Fiennes', '1962-12-22', 0, 35, 0, 1),
('MN000000020', 'Morgan Freeman', '1937-06-01', 0, 50, 0, 1),
('BP000000021', 'Brad Pitt', '1963-12-18', 2, 50, 1, 1),
('JG000000022', 'Jake Gyllenhaal', '1980-12-19', 0, 30, 0, 1),
('JM000000023', 'Joaquin Phoenix', '1974-10-28', 0, 40, 0, 1),
('MC000000024', 'Michael Cera', '1988-06-07', 0, 20, 0, 1),
('JH000000025', 'Jonah Hill', '1983-12-20', 1, 30, 1, 1),
('AK000000026', 'Asghar Farhadi', '1972-05-07', 12, 0, 1, 0),
('TS000000027', 'Tom Hanks', '1956-07-09', 2, 70, 1, 1),
('MA000000028', 'Matt Damon', '1970-10-08', 0, 60, 0, 1),
('JF000000029', 'Javier Bardem', '1969-03-01', 0, 40, 0, 1),
('JG000000030', 'Josh Brolin', '1968-02-12', 0, 40, 0, 1),
('CB000000031', 'Clint Eastwood', '1930-05-31', 30, 60, 1, 1),
('CW000000032', 'Casey Affleck', '1975-08-12', 0, 25, 0, 1),
('SC000000033', 'Sergio Leone', '1929-01-03', 12, 0, 1, 0),
('DP000000034', 'Damien Chazelle', '1985-01-19', 5, 0, 1, 0),
('BA000000035', 'Baz Luhrmann', '1962-09-17', 6, 1, 1, 1),
('NK000000036', 'Nicole Kidman', '1967-06-20', 0, 45, 0, 1),
('EM000000037', 'Ewan McGregor', '1971-03-31', 0, 50, 0, 1),
('RM000000038', 'Rumi Hiiragi', '1987-08-01', 0, 10, 0, 1),
('HM000000039', 'Hayao Miyazaki', '1941-01-05', 25, 0, 1, 0),
('JG000000040', 'Jake Johnson', '1978-05-28', 0, 25, 0, 1),
('GH000000041', 'Greta Gerwig', '1983-08-04', 4, 20, 1, 1),
('JJ000000042', 'Julie Delpy', '1969-12-21', 3, 25, 1, 1),
('EH000000043', 'Ethan Hawke', '1970-11-06', 0, 45, 0, 1),
('KH000000044', 'Keira Knightley', '1985-03-26', 0, 30, 0, 1),
('MF000000045', 'Matthew Macfadyen', '1974-10-17', 0, 25, 0, 1),
('HB000000046', 'Humphrey Bogart', '1899-12-25', 0, 40, 0, 1),
('IB000000047', 'Ingrid Bergman', '1915-08-29', 0, 35, 0, 1)